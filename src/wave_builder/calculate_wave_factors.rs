...
// Created: 2024
// File Path: src/wave_builder/calculate_wave_factors.rs
// ------------------------------------------------------------
...
impl WaveBuilder {
    pub fn calculate_wave_factors(&mut self) -> [f64; 248] {
        ...
        self.cos_ap_psi[0][2] = self.cos_ap_psi[0][1] * self.cos_ap_psi[0][1]
            - self.sin_ap_psi[0][1] * self.sin_ap_psi[0][1];
        self.sin_ap_psi[0][2] = 2.0 * self.cos_ap_psi[0][1] * self.sin_ap_psi[0][1];
        self.cos_ap_psi[0][3] = self.cos_ap_psi[0][2] * self.cos_ap_psi[0][1]
            - self.sin_ap_psi[0][2] * self.sin_ap_psi[0][1];
        self.sin_ap_psi[0][3] = self.sin_ap_psi[0][2] * self.cos_ap_psi[0][1]
            + self.cos_ap_psi[0][2] * self.sin_ap_psi[0][1];
        self.cos_ap_psi[0][4] = self.cos_ap_psi[0][3] * self.cos_ap_psi[0][1]
            - self.sin_ap_psi[0][3] * self.sin_ap_psi[0][1];
        self.sin_ap_psi[0][4] = self.sin_ap_psi[0][3] * self.cos_ap_psi[0][1]
            + self.cos_ap_psi[0][3] * self.sin_ap_psi[0][1];
        self.cos_ap_psi[0][5] = self.cos_ap_psi[0][4] * self.cos_ap_psi[0][1]
            - self.sin_ap_psi[0][4] * self.sin_ap_psi[0][1];
        self.sin_ap_psi[0][5] = self.sin_ap_psi[0][4] * self.cos_ap_psi[0][1]
            + self.cos_ap_psi[0][4] * self.sin_ap_psi[0][1];
        ...
        self.cos_ap_psi[2][0] = self.cos_ap_psi[1][0] * self.cos_ap_psi[1][0]
            - self.sin_ap_psi[1][0] * self.sin_ap_psi[1][0];
        self.sin_ap_psi[2][0] = 2.0 * self.cos_ap_psi[1][0] * self.sin_ap_psi[1][0];
        self.cos_ap_psi[3][0] = self.cos_ap_psi[2][0] * self.cos_ap_psi[1][0]
            - self.sin_ap_psi[2][0] * self.sin_ap_psi[1][0];
        self.sin_ap_psi[3][0] = self.sin_ap_psi[2][0] * self.cos_ap_psi[1][0]
            + self.cos_ap_psi[2][0] * self.sin_ap_psi[1][0];
        self.cos_ap_psi[4][0] = self.cos_ap_psi[3][0] * self.cos_ap_psi[1][0]
            - self.sin_ap_psi[3][0] * self.sin_ap_psi[1][0];
        self.sin_ap_psi[4][0] = self.sin_ap_psi[3][0] * self.cos_ap_psi[1][0]
            + self.cos_ap_psi[3][0] * self.sin_ap_psi[1][0];
        self.cos_ap_psi[5][0] = self.cos_ap_psi[4][0] * self.cos_ap_psi[1][0]
            - self.sin_ap_psi[4][0] * self.sin_ap_psi[1][0];
        self.sin_ap_psi[5][0] = self.sin_ap_psi[4][0] * self.cos_ap_psi[1][0]
            + self.cos_ap_psi[4][0] * self.sin_ap_psi[1][0];

        // Now basically calculate all possible combinations and weight according to the
        // noise at a given frequency
        for k in 1..5 {
            for j in 1..5 {
                self.cos_ap_psi[j][k] = self.cos_ap_psi[j][0] * self.cos_ap_psi[0][k]
                    - self.sin_ap_psi[j][0] * self.sin_ap_psi[0][k];
                self.cos_am_psi[j][k] = self.cos_ap_psi[j][0] * self.cos_ap_psi[0][k]
                    + self.sin_ap_psi[j][0] * self.sin_ap_psi[0][k];
                self.sin_ap_psi[j][k] = self.sin_ap_psi[j][0] * self.cos_ap_psi[0][k]
                    + self.cos_ap_psi[j][0] * self.sin_ap_psi[0][k];
                self.sin_am_psi[j][k] = self.sin_ap_psi[j][0] * self.cos_ap_psi[0][k]
                    - self.cos_ap_psi[j][0] * self.sin_ap_psi[0][k];
            }
